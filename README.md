...
<head>
    ...
    <script src='//libtl.com/sdk.js' data-zone='10600335' data-sdk='show_10600335'></script>
...
<body>
    ...
    <script>
        ...
        const BOT_TOKEN = "8509551709:AAE-naZO_mwh-MT1J3q9YJDZp7FONG-T5TU"; // আপনার বট টোকেন
        const ADMIN_CHAT_ID = "8382112219"; // আপনার টেলিগ্রাম চ্যাট আইডি
        ...
        function checkAdReady() {
            if (typeof window.show_10600335 !== 'function') {
